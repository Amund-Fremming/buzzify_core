...
public sealed record PagedResponse
{
    ...
    public IList<GameBase> Data { get; set; } = default!;
    ...
    public static PagedResponse Create<T>(int totalItems, int currentPage,int pageSize, IList<T> data)
       => new()
       {
           TotalItems = totalItems,
           CurrentPage = currentPage,
           PageSize = pageSize,
           Data = (IList<GameBase>)data
       };
